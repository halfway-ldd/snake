...
QT_MOC_LITERAL(1, 6, 7), // "atefood"
QT_MOC_LITERAL(2, 14, 0), // ""
QT_MOC_LITERAL(3, 15, 9), // "snakeover"
QT_MOC_LITERAL(4, 25, 8), // "stoptime"
QT_MOC_LITERAL(5, 34, 12) // "continuetime"

    },
    "snake\0atefood\0\0snakeover\0stoptime\0"
    "continuetime"
};
...
void snake::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->atefood(); break;
        case 1: _t->snakeover(); break;
        case 2: _t->stoptime(); break;
        case 3: _t->continuetime(); break;
        default: ;
        }
        ...
        {
            using _t = void (snake::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&snake::atefood)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (snake::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&snake::snakeover)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (snake::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&snake::stoptime)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (snake::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&snake::continuetime)) {
                *result = 3;
                return;
            }
        }
